...
/** Constructor of _MAPFSAT_AtParallelMksAll.
*
* @param sol_name name of the encoding used in log. Defualt value is at_parallel_mks_all.
*/
_MAPFSAT_AtParallelMksAll::_MAPFSAT_AtParallelMksAll(string sol_name)
{
...
int _MAPFSAT_AtParallelMksAll::CreateFormula(int time_left)
{
