...
/** Constructor of _MAPFSAT_MonosatPassParallelMksAll.
*
* @param sol_name name of the encoding used in log. Defualt value is pass_parallel_mks_all.
*/
_MAPFSAT_MonosatPassParallelMksAll::_MAPFSAT_MonosatPassParallelMksAll(string sol_name)
{
...
int _MAPFSAT_MonosatPassParallelMksAll::CreateFormula(int time_left)
{
