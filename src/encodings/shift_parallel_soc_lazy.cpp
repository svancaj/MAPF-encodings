...
/** Constructor of _MAPFSAT_ShiftParallelSocLazy.
*
* @param sol_name name of the encoding used in log. Defualt value is shift_parallel_soc_all.
*/
_MAPFSAT_ShiftParallelSocLazy::_MAPFSAT_ShiftParallelSocLazy(string sol_name)
{
...
int _MAPFSAT_ShiftParallelSocLazy::CreateFormula(int time_left)
{
