...
*/
_MAPFSAT_MonosatPebbleSocAll::_MAPFSAT_MonosatPebbleSocAll(string sol_name)
{
...
int _MAPFSAT_MonosatPebbleSocAll::CreateFormula(vector<vector<int> >& CNF, int time_left)
{
